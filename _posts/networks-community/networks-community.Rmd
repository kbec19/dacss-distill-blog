...
## Creating a function to extract the giant component
...
The walktrap community detection made two communities; one community is the lone isolate, and the rest of the songwriters are in the other community.
